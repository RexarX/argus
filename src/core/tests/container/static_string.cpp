...
using namespace argus::container;

TEST_SUITE("container::StaticString") {
  TEST_CASE("container::StaticString::ctor: construction and assignment") {
    ...
    SUBCASE("Construction from string literal") {
      StaticString<32> str = "Hello, World!";
      CHECK_EQ(str.Size(), 13);
      CHECK_EQ(str.View(), "Hello, World!");
    }

    SUBCASE("Construction from count and character") {
      StaticString<32> str(5, 'x');
      CHECK_EQ(str.Size(), 5);
      CHECK_EQ(str.View(), "xxxxx");
    }

    SUBCASE("Construction from pointer and length") {
    ...
    SUBCASE("Copy and move construction") {
      ...
      StaticString<32> move_source = "Move me";
      StaticString<32> moved = std::move(move_source);
    ...
    SUBCASE("Copy and move assignment") {
      ...
      StaticString<32> str3 = "First";
      StaticString<32> str4 = "Second";
      str3 = std::move(str4);
      CHECK_EQ(str3.View(), "Second");
    }
  }
  ...
  TEST_CASE("container::StaticString::Front/Back: element access") {
    SUBCASE("Front read and write") {
      ...
      str.Front() = 'B';
      CHECK_EQ(str.View(), "Best");
    }

    SUBCASE("Back read and write") {
      StaticString<32> str = "Test";
      CHECK_EQ(str.Back(), 't');

      str.Back() = 'd';
      CHECK_EQ(str.View(), "Tesd");
    }
  }
  ...
  TEST_CASE(
      "container::StaticString::Modifiers: replace() with shorter string") {
  ...
  TEST_CASE(
      "container::StaticString::Operations: compare() with different "
      "capacity") {
  ...
  TEST_CASE(
      "container::StaticString::Comparison: operator== with same capacity") {
    StaticString<32> str1 = "Hello";
  ...
  TEST_CASE(
      "container::StaticString::Comparison: operator== with different "
      "capacity") {
    StaticString<32> str1 = "Hello";
    StaticString<64> str2 = "Hello";
    StaticString<64> str3 = "World";
  ...
  TEST_CASE(
      "container::StaticString::Comparison: operator== with string_view") {
    StaticString<32> str = "Hello";
  ...
  TEST_CASE(
      "container::StaticString::Non-member: operator+ two StaticStrings") {
  ...
  TEST_CASE(
      "container::StaticString::Non-member: operator+ StaticString and "
      "string_view") {
    StaticString<32> str = "Hello";
  ...
  TEST_CASE(
      "container::StaticString::Non-member: operator+ string_view and "
      "StaticString") {
    StaticString<32> str = " World";
  ...
  TEST_CASE(
      "container::StaticString::Modifiers: AssignRange() clears existing "
      "content") {
  ...
  TEST_CASE(
      "container::StaticString::Modifiers: AppendRange() with empty range") {
    StaticString<32> str("Hello");
  ...
  TEST_CASE(
      "container::StaticString::Modifiers: InsertRange() with empty range") {
    StaticString<32> str("Test");
    std::vector<char> empty;
  ...
  TEST_CASE(
      "container::StaticString::Modifiers: ReplaceWithRange() with longer "
      "range") {
    StaticString<32> str("Hi");
  ...
  TEST_CASE(
      "container::StaticString::Modifiers: ReplaceWithRange() with shorter "
      "range") {
    StaticString<32> str("Hello World");
  ...
  TEST_CASE(
      "container::StaticString::Modifiers: ReplaceWithRange() in middle") {
    StaticString<32> str("abcdef");
  ...
  TEST_CASE(
      "container::StaticString::Modifiers: ReplaceWithRange() with empty "
      "range") {
    StaticString<32> str("Hello World");
    std::vector<char> empty;
  ...
  TEST_CASE(
      "container::StaticString::Range operations: chain multiple operations") {
    StaticString<32> str;
    std::string s1 = "Hello";
    std::string s2 = " ";
    std::string s3 = "World";
  ...
  TEST_CASE(
      "container::StaticString::Heterogeneous: copy constructor from smaller "
      "capacity") {
  ...
  TEST_CASE(
      "container::StaticString::Heterogeneous: copy constructor preserves "
      "content") {
  ...
  TEST_CASE(
      "container::StaticString::Heterogeneous: move constructor from smaller "
      "capacity") {
    StaticString<16> source("Small");
  ...
  TEST_CASE(
      "container::StaticString::Heterogeneous: move constructor with larger "
      "string") {
  ...
  TEST_CASE(
      "container::StaticString::Heterogeneous: copy assignment from smaller "
      "capacity") {
    StaticString<16> source("Small");
  ...
  TEST_CASE(
      "container::StaticString::Heterogeneous: copy assignment replaces "
      "content") {
  ...
  TEST_CASE(
      "container::StaticString::Heterogeneous: move assignment from smaller "
      "capacity") {
    StaticString<16> source("Small");
    StaticString<32> dest("Initial");
  ...
  TEST_CASE(
      "container::StaticString::Heterogeneous: move assignment with larger "
      "string") {
    StaticString<20> source("Hello World");
  ...
  TEST_CASE(
      "container::StaticString::Heterogeneous: chain heterogeneous "
      "operations") {
  ...
  TEST_CASE(
      "container::StaticString::Heterogeneous: different character access "
      "after copy") {
  ...
  TEST_CASE(
      "container::StaticString::Heterogeneous: modification after "
      "heterogeneous copy") {
  ...
  TEST_CASE(
      "container::StaticString::Format: StaticString with left alignment") {
    StaticString<32> str("Test");
  ...
  TEST_CASE(
      "container::StaticString::Format: StaticString with right alignment") {
    StaticString<32> str("Test");
    auto formatted = std::format("{:>8}", str);
  ...
  TEST_CASE(
      "container::StaticString::Format: StaticString with center alignment") {
    StaticString<32> str("Test");
    auto formatted = std::format("{:^8}", str);
  ...
  TEST_CASE(
      "container::StaticString::Format: StaticString in complex format "
      "string") {
  ...
  TEST_CASE(
      "container::StaticString::Format: StaticString with width specifier") {
  ...
  TEST_CASE(
      "container::StaticString::Format: long StaticString with truncation "
      "spec") {
  ...
  TEST_CASE(
      "container::StaticString::Format: StaticString with numeric context") {
  ...
  TEST_CASE(
      "container::StaticString::Format: heterogeneous StaticString in format") {
    StaticString<16> small("Test");
  ...
  TEST_CASE(
      "container::StaticString::Format: StaticString via string_view "
      "conversion") {
    StaticString<32> str("Convert");
  ...
  TEST_CASE(
      "container::StaticString::Format: StaticString with special characters") {
    StaticString<32> str("Hello\nWorld");
    auto formatted = std::format("{}", str);
  ...
  TEST_CASE(
      "container::StaticString::Constructor: from_range_t with empty range") {
    std::vector<char> empty;
  ...
  TEST_CASE(
      "container::StaticString::Constructor: from_range_t at capacity limit") {
  ...
  TEST_CASE(
      "container::StaticString::Constructor: initializer_list single "
      "character") {
  ...
  TEST_CASE(
      "container::StaticString::Constructor: initializer_list at capacity") {
  ...
  TEST_CASE(
      "container::StaticString::Constructor: string_view substring from "
      "position") {
  ...
  TEST_CASE(
      "container::StaticString::Constructor: string_view substring with "
      "count") {
    std::string_view sv("HelloWorld");
  ...
  TEST_CASE(
      "container::StaticString::Constructor: string_view substring middle") {
    std::string_view sv("HelloWorld");
  ...
  TEST_CASE(
      "container::StaticString::Constructor: string_view substring position "
      "zero") {
  ...
  TEST_CASE(
      "container::StaticString::Constructor: substring copy from position") {
  ...
  TEST_CASE(
      "container::StaticString::Constructor: substring move from position") {
    StaticString<32> source("HelloWorld");
  ...
  TEST_CASE(
      "container::StaticString::Constructor: substring copy from smaller "
      "capacity") {
  ...
  TEST_CASE(
      "container::StaticString::Constructor: substring copy from smaller with "
      "count") {
    StaticString<16> source("HelloWorld");
    StaticString<32> str(source, 0, 5);
  ...
  TEST_CASE(
      "container::StaticString::Constructor: substring move from smaller "
      "capacity") {
    StaticString<16> source("HelloWorld");
    StaticString<32> str(std::move(source), 5);
  ...
  TEST_CASE(
      "container::StaticString::Constructor: substring move from smaller with "
      "count") {
    StaticString<16> source("HelloWorld");
    StaticString<32> str(std::move(source), 0, 5);
  ...
  TEST_CASE(
      "container::StaticString::Constructor: from_range with heterogeneous "
      "assignment") {
    std::vector<int> nums = {65, 66, 67};  // ASCII for A, B, C
    StaticString<32> str(std::from_range,
                         nums | std::views::transform([](int n) {
  ...
  TEST_CASE(
      "container::StaticString::Constructor: initializer_list copy to larger "
      "capacity") {
  ...
  TEST_CASE(
      "container::StaticString::Constructor: string_view substring empty") {
    std::string_view sv("Test");
  ...
  TEST_CASE(
      "container::StaticString::Constructor: substring chain multiple levels") {
  ...
  TEST_CASE(
      "container::StaticString::Constructor: initializer_list special "
      "characters") {
    StaticString<32> str({' ', '\t', '\n', 'X'});

...
#   ARGUS_${MODULE_NAME}_ENABLE_SANITIZERS       - Master switch for sanitizers (default: ON for Debug)
#   ARGUS_${MODULE_NAME}_SANITIZER_ADDRESS       - Enable AddressSanitizer (default: ON)
#   ARGUS_${MODULE_NAME}_SANITIZER_UNDEFINED     - Enable UndefinedBehaviorSanitizer (default: ON)
#   ARGUS_${MODULE_NAME}_SANITIZER_THREAD        - Enable ThreadSanitizer (default: OFF, mutually exclusive with ASan)
#   ARGUS_${MODULE_NAME}_SANITIZER_MEMORY        - Enable MemorySanitizer (default: OFF, Clang only)
#
# Notes:
...
set(ARGUS_${MODULE_NAME}_COMPILER_IS_GNU OFF)
set(ARGUS_${MODULE_NAME}_COMPILER_IS_CLANG OFF)
set(ARGUS_${MODULE_NAME}_COMPILER_IS_MSVC OFF)
set(ARGUS_${MODULE_NAME}_COMPILER_IS_CLANG_CL OFF)

if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
  set(ARGUS_${MODULE_NAME}_COMPILER_IS_GNU ON)
elseif(CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
  if(MSVC OR CMAKE_CXX_COMPILER_FRONTEND_VARIANT STREQUAL "MSVC")
    set(ARGUS_${MODULE_NAME}_COMPILER_IS_CLANG_CL ON)
  else()
    set(ARGUS_${MODULE_NAME}_COMPILER_IS_CLANG ON)
  endif()
elseif(CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
  set(ARGUS_${MODULE_NAME}_COMPILER_IS_MSVC ON)
endif()
...
option(ARGUS_${MODULE_NAME}_ENABLE_SANITIZERS "Enable sanitizers for Debug builds" ON)

# Individual sanitizer options
option(ARGUS_${MODULE_NAME}_SANITIZER_ADDRESS "Enable AddressSanitizer" ON)
option(ARGUS_${MODULE_NAME}_SANITIZER_UNDEFINED "Enable UndefinedBehaviorSanitizer" ON)
option(ARGUS_${MODULE_NAME}_SANITIZER_THREAD "Enable ThreadSanitizer (mutually exclusive with ASan)" OFF)
option(ARGUS_${MODULE_NAME}_SANITIZER_MEMORY "Enable MemorySanitizer (Clang only, requires instrumented libc++)" OFF)
...
if(ARGUS_${MODULE_NAME}_SANITIZER_ADDRESS AND ARGUS_${MODULE_NAME}_SANITIZER_THREAD)
  message(WARNING "AddressSanitizer and ThreadSanitizer cannot be used together. Disabling ThreadSanitizer.")
  set(ARGUS_${MODULE_NAME}_SANITIZER_THREAD OFF CACHE BOOL "Enable ThreadSanitizer" FORCE)
endif()

if(ARGUS_${MODULE_NAME}_SANITIZER_ADDRESS AND ARGUS_${MODULE_NAME}_SANITIZER_MEMORY)
  message(WARNING "AddressSanitizer and MemorySanitizer cannot be used together. Disabling MemorySanitizer.")
  set(ARGUS_${MODULE_NAME}_SANITIZER_MEMORY OFF CACHE BOOL "Enable MemorySanitizer" FORCE)
endif()

if(ARGUS_${MODULE_NAME}_SANITIZER_THREAD AND ARGUS_${MODULE_NAME}_SANITIZER_MEMORY)
...
if(ARGUS_${MODULE_NAME}_SANITIZER_MEMORY AND NOT ARGUS_${MODULE_NAME}_COMPILER_IS_CLANG)
  message(WARNING "MemorySanitizer is only available with Clang. Disabling MemorySanitizer.")
  set(ARGUS_${MODULE_NAME}_SANITIZER_MEMORY OFF CACHE BOOL "Enable MemorySanitizer" FORCE)
endif()

# MSVC only supports ASan
if(ARGUS_${MODULE_NAME}_COMPILER_IS_MSVC OR ARGUS_${MODULE_NAME}_COMPILER_IS_CLANG_CL)
  if(ARGUS_${MODULE_NAME}_SANITIZER_UNDEFINED)
    message(STATUS "UndefinedBehaviorSanitizer is not supported on MSVC. Disabling.")
    set(ARGUS_${MODULE_NAME}_SANITIZER_UNDEFINED OFF CACHE BOOL "Enable UndefinedBehaviorSanitizer" FORCE)
  endif()
  if(ARGUS_${MODULE_NAME}_SANITIZER_THREAD)
    message(STATUS "ThreadSanitizer is not supported on MSVC. Disabling.")
    set(ARGUS_${MODULE_NAME}_SANITIZER_THREAD OFF CACHE BOOL "Enable ThreadSanitizer" FORCE)
  endif()
  if(ARGUS_${MODULE_NAME}_SANITIZER_MEMORY)
...
function(_argus_get_sanitizer_flags OUT_COMPILE_FLAGS OUT_LINK_FLAGS)
  ...
  if(ARGUS_${MODULE_NAME}_COMPILER_IS_GNU OR ARGUS_${MODULE_NAME}_COMPILER_IS_CLANG)
    set(_sanitizers "")

    if(ARGUS_${MODULE_NAME}_SANITIZER_ADDRESS)
...
function(argus_target_enable_sanitizers TARGET)
  if(NOT ARGUS_${MODULE_NAME}_ENABLE_SANITIZERS)
    return()
  endif()
  ...
  if(ARGUS_COMPILER_IS_MSVC OR ARGUS_${MODULE_NAME}_COMPILER_IS_CLANG_CL)

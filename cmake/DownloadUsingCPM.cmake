# CPM (CMake Package Manager) integration for Argus
...
set(CPM_USE_LOCAL_PACKAGES OFF CACHE BOOL "Try to use local packages before downloading")
...
macro(argus_cpm_add_package)
  ...
  if(NOT CPM_ARG_NAME)
    message(FATAL_ERROR "argus_cpm_add_package: NAME is required")
  endif()
  ...
  if(${CPM_ARG_NAME}_ADDED)
    ...
    # Note: SYSTEM marking is deferred - use argus_cpm_mark_as_system() function
...
function(argus_print_cpm_packages)
  if(CPM_PACKAGES)
...
function(argus_cpm_add_github_package)
  set(options)
  ...
  if(NOT ARG_NAME OR NOT ARG_REPOSITORY)
    message(FATAL_ERROR "argus_cpm_add_github_package: NAME and REPOSITORY are required")
  endif()
